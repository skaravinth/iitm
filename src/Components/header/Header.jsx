...
{Popup && (<div>
        <Summa children={<Profilepage setPopup={setPopup} />} direction="right" borderRadius="12px" />
      </div>)}
      <div className="flex justify-end items-center">
      <div className="text-black font-bold mr-15">ABOUT</div>
    <div className="text-black font-bold mr-15">SHOPPING PAGE</div>
